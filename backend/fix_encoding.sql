-- Fix character encoding for Marathi text
USE khandesh_vivah;

-- Alter database to use utf8mb4
ALTER DATABASE khandesh_vivah CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

-- Alter tables to use utf8mb4
...
-- Insert data with proper encoding
...
SELECT '✅ Database encoding fixed and data re-inserted with utf8mb4!' as Status;
